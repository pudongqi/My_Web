...
General = {
    ...
    rewardLoader: function() {
        ...
        General.isWechat && $(".wechat-code b").html("长按二维码打赏作者"),
...
$(document).ready(function() {
        ...
        this.each(function() {
            ...
            function() {
                if (!this.loaded) {
                    ...
                    var o = e.attr("data-" + i.data_attribute); (o.indexOf("upaiyun") > -1 || o.indexOf("file.is26.com") > -1) && (1 == i.advanced_load && (o += "!"), 1 == i.is_scale && (o += "/fw/" + i.scale_width), 1 == i.webP_load && (o += "/format/webp")),
                    $("<img />").bind("load",
                    function() {
                        e.hide(),
    ...
    $("body").hasClass("post-template") && (General.addIcons(),General.webFontLoader())
});