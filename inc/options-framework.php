...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( '主题设置 - WBOX西部盒子', 'optionsframework'),
		'menu_title' => __('主题设置', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'wbox-options',
		'callback' => 'optionsframework_page',
		'icon_url' => OPTIONS_FRAMEWORK_DIRECTORY.'images/wbset.png',
		'position' => 60
	);
...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page( $menu['page_title'], $menu['menu_title'], $menu['capability'], $menu['menu_slug'], $menu['callback'] ,$menu['icon_url'],$menu['position']);
...
function optionsframework_page() { ?>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submittop">
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( '设置保存成功！', 'options_framework_theme' ), 'updated fade' );
}
